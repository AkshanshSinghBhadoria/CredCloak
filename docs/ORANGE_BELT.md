...
```bash
NEXT_PUBLIC_CONTRACT_ADDRESS=CDHNF2LNW6SAFFW3CDT4LQFEMV5KF3ZYCH5DLKUKBWUJAYTP3RH52RET
NEXT_PUBLIC_LOAN_POOL_ADDRESS=CBX44C272X6X2LNW6SAFFW3CDT4LQFEMV5KF3ZYCH5DLKUKBWUJAYTP3RH52
NEXT_PUBLIC_ZK_MIN_BALANCE_XLM=100
NEXT_PUBLIC_ZK_MAX_DTI_PERCENT=50
```
